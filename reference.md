...
- [Introduction](#introduction)
  * [Modules](#modules)
    ...
    + [Returns](#returns)
    + [Example:](#example-)
    + [These are the available options when calling `Model` to initialize the connection and get access to the `Model` function](#these-are-the-available-options-when-calling--model--to-initialize-the-connection-and-get-access-to-the--model--function)
  * [`Model(model, name, syncInterval)`](#-model-model--name--syncinterval--)
    + [Arguments](#arguments)
      - [`model`](#-model-)
      - [`name`](#-name-)
  ...
  * [Static methods](#static-methods)
    + [`derive(deriveModel)`](#-derive-derivemodel--)
    ...
    + [`collectionReady()`](#-collectionready---)
      - [Returns](#returns-5)
    + [`remodel(options)`](#-remodel-options--)
      - [Arguments](#arguments-3)
        * [options](#options)
      - [Returns](#returns-6)
    + [`clear(which)`](#-clear-which--)
    ...
    + [Data retrieval methods](#data-retrieval-methods)
      - [`get(which)`](#-get-which--)
        * [Arguments](#arguments-5)
          + [`which`](#-which--1)
        * [Returns](#returns-8)
      - [`getAll(which, sortBy, limit=0, skip=0)`](#-getall-which--sortby--limit-0--skip-0--)
        * [Arguments](#arguments-6)
          ...
          + [`skip`](#-skip-)
        * [Returns](#returns-9)
      - [`map(which, index, returnArray, limit=0, skip=0)`](#-map-which--index--returnarray--limit-0--skip-0--)
        * [Arguments](#arguments-7)
          ...
          + [`skip`](#-skip--1)
        * [Returns](#returns-10)
      - [`has(which, returnDocument)`](#-has-which--returndocument--)
        * [Arguments](#arguments-8)
          + [`which`](#-which--4)
          + [`returnDocument`](#-returndocument-)
        * [Returns](#returns-11)
      - [`count(which)`](#-count-which--)
        * [Arguments](#arguments-9)
          + [`which`](#-which--5)
      - [Returns](#returns-12)
      - [`join(which,joinWith,localField,foreignField,joinAs,returnAsModel=false)`](#-join-which-joinwith-localfield-foreignfield-joinas-returnasmodel-false--)
        * [Arguments](#arguments-10)
          + [`which`](#-which--6)
          + [`joinWith`](#-joinwith-)
          + [`localField`](#-localfield-)
          + [`joinAs`](#-joinas-)
          + [`returnAsModel`](#-returnasmodel-)
        * [Example](#example-2)
        * [Returns](#returns-13)
      - [`joinAll(which, joinOpts, findOpts, returnAsModel=false)`](#-joinall-which--joinopts--findopts--returnasmodel-false--)
  ...
  * [Instance methods](#instance-methods)
    ...
    + [`changed(property, newValue, oldValue)`](#-changed-property--newvalue--oldvalue--)
      - [Arguments](#arguments-13)
        * [`property`](#-property-)
        * [`newValue`](#-newvalue-)
        * [`oldValue`](#-oldvalue-)
    + [`$onUpdate (property, value, callback)`](#--onupdate--property--value--callback--)
